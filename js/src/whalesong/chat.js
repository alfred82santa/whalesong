...
export class ChatManager extends ModelManager {
  ...
  constructor(model) {
    ...
    this.addSubmanager('presence', new PresenceManager(this.model.presence); this.addSubmanager('contact', new ContactManager(this.model.contact)); this.addSubmanager('mute', new MuteManager(this.model.mute));
