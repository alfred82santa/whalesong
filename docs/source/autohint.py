# From https://github.com/agronholm/sphinx-autodoc-typehints
#
# I made changes to support Results

import inspect
from typing import get_type_hints, TypeVar, Any, AnyStr, Generic, Union, Awaitable
...
def format_annotation(annotation):
    ...
    if annotation_cls.__module__ == 'typing':
        ...
        if Generic in annotation_cls.mro():
            params = getattr(annotation, '__args__', None) or getattr(annotation, '__parameters__', None) or ()
